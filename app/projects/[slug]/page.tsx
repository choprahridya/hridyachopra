...
const projects: Record<string, {
  ...
  '1': {
    ...
    year: '2025',
    description: 'A book exchange platform designed to make reading more accessible and sustainable — enabling communities to share, swap, and extend the life of every book.',
    sections: [
      {
        type: 'text',
        label: 'Overview',
